...
- Create Angular project with ng: `ng new financetracker.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`financetracker.client.esproj`).
