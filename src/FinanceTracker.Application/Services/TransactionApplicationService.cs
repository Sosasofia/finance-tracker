...
public class TransactionApplicationService : ITransactionApplicationService
{
    ...
    /// </summary>
    public async Task<Response<TransactionResponse>> AddTransactionAsync(CreateTransaction transactionCreateDTO, Guid userID)
    {
    ...
    public async Task<Response<TransactionResponse>> UpdateTransactionAsync(Guid transactionId, UpdateTransaction transactionUpdateDTO, Guid userId)
    {
        var transaction = await _transactionRepository.GetTransactionsByIdAndUserAsync(transactionId, userId);
    ...
    private IEnumerable<Installment> GenerateInstallments(CreateTransaction transaction)
    {
